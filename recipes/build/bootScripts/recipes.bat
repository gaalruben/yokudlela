...
set JARPATH=%APP_HOME%\lib\recipes-1.0-SNAPSHOT.jar

@rem Execute recipes
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RECIPES_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%RECIPES_EXIT_CONSOLE%" exit 1
exit /b 1
